...
This roadmap tracks major goals and ongoing work for *Purge of the Crescent Veil*. It is updated as development progresses so contributors can quickly see what is complete and what remains.
...
- New documents covering meltdown scenarios and radiation handling are located in
  `docs/archive/quantum_peril_scenarios.md` and
  `docs/archive/radiation_exposure_handling.md`. These outline possible future hazards for quantum hardware. The current engine relies on software-based simulation.
